...
def train_loop(model, optimizer, n_checkpoints, X_train, y_train, X_test, y_test, f_train, f_test, D, 
               start_epoch, n_epochs, batch_size,model_results_path, device, new_lr=None):
