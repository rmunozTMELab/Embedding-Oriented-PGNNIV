...
class AutoencoderTransferLearning(nn.Module):
    ...
    def __init__(self, input_size, predictive_layers, pretrained_encoder, output_predictive_size, explanatory_input_size, explanatory_layers, output_explanatory_size, n_filters):
